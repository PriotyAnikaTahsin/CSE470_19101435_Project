        ...
        <nav class="background-transparent background-transparent-hightlight full-width sticky">
          <div class="s-12 l-2">
            <a href="index.html" class="logo">
              ...
              <img class="logo-before" src="<?=ASSETS?>minima/img/bcr.jpg" alt="">
              <!-- Logo version after sticky nav -->
              <img class="logo-after" src="<?=ASSETS?>minima/img/bcr.jpg" alt="">
            </a>
          </div>
          ...
          <div class="s-12 l-10">
            <div class="top-nav right">
              ...
              <ul class="right chevron">
                <li><a href="<?=ROOT?>adminhome">Home</a></li>
...
<li><a href="<?=ROOT?>PoliceList">Police List</a></li>
                  <li><a href="<?=ROOT?>CriminalsList">Criminal List</a></li>
