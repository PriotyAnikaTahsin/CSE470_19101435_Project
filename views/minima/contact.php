          ...
          <section class="full-width background-dark">
            ...
            <div class="s-12 m-12 l-6 text-center">
              <div class="padding-2x">
                ...
                <h2 class="text-size-20 margin-bottom-0 text-white">Address</h2>                
                <p> 6 Phoenix Rd</p>
                <p>Dhaka 1000, Bangladesh Police Criminal Record Management Headquarters</p>
                <p>Bangladesh</p>
                ...
                <a class="text-primary-hover" href="mailto:contact@sampledomain.com">BCRM@Bd.record.management</a><br>
                <a class="text-primary-hover" href="mailto:office@sampledomain.com">office_BCRM@gmail.com</a>
